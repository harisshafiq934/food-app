...
function Pizza({ pizza }) {
  ...
  return (
    ...
    <div className="back-ground shadow-lg p-3 mb-2  bg-white  rounded  " >
     ...
     <h1  style={{display:'flex',justifyContent:'center'}}>{pizza.name}</h1>
      <center>
      <img 
        src={pizza.image}
      ...
      <Modal show={show} onHide={handleClose} >
        ...
        <Modal.Body>
          <center>
         <img src={pizza.image} alt="" className="img-fluid" style={{height:"150px", width:"150px", borderRadius:'8%' }}/> </center>
